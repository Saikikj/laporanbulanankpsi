...
class CreateMarkasSimpananLaptopsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('markas_simpanan_laptops', function (Blueprint $table) {
            $table->id();
            $table->string('unit');
    ...
    {
        Schema::dropIfExists('markas_simpanan_laptops');
    }
}
