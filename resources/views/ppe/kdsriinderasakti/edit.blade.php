                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Tambah Peralatan PPE</h3></div>
                                <!-- <div class="col-sm-4">
                            ...
                            <!-- INPUT -->
<form action="/ppe/kdsriinderasakti/update/{{$data->id}}" method="POST" id="userformcreate">
@csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div id="">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="peralatan" type="text"
                                                ...
                                                name="peralatan" value="{{ $data->peralatan }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="model" type="text"
                                            ...
                                            value="{{ $data->model}}" placeholder="Model Peralatan" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="statuskeupayaan" type="text"
                                            ...
                                            value="{{ $data->statuskeupayaan }}" required>
                                    </div>
                                </div>
                        ...
                        <a href="/ppe/kdsriinderasakti"><button type="button" class="btn btn-default">Back</button>
