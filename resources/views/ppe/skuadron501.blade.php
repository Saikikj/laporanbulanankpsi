                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Peralatan PE SKUADRON 501</h3></div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/ppe/skuadron501/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/ppe/skuadron501/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                 </td>
                                 {{--
                                <td><a href="ppe/skuadron501/{{$data->id}}"><i class="material-icons">&#xE254;</i></a>
                                            <form method="post"
                                            action="ppe/skuadron501/{{ $data->id }}">
                                            @csrf
                                            @method('delete')
                        ...
                        <a href="/ppe/skuadron501/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
                        </a>
                    </div>
                </div>
            </div>
