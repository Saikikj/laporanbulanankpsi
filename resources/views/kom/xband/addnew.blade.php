                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div>&nbsp</div>
                                <form action="/kom/xband/manpack" method="POST" id="userformcreate">
                                    @csrf
                                    <select name="peralatan_select" id="peralatan_select">
                                    <option id="manpack" value ="manpack">Manpack</option>
                                    <option id="fixedterminal" value="fixedterminal">Fixed Terminal</option>
                                    <option id="navalterminal" value="navalterminal">Naval Terminal</option>
                                    <option id="cotp" value="cotp">COTP</option>
                                    <option id="cotm" value="cotm">COTM</option>
                                    <option id="flyawaykit" value="flyawaykit">Flyaway Kit</option>
                                </select>
                                    <div id="manpack_form" style="display:none;">
                                            ...
                                            <label for="penempatan"
                                                ...
                                                <div class="col-md-6">
                                                    <input id="penempatan" type="text"
                                                        ...
                                                        name="penempatan" value="{{ old('penempatan') }}" required>
                                                </div>
                                        </div>
                        ...
                        <!-- ------------------------------------------------ Fixed Terminal ----------------------------------------- -->
                        <div id="fixedterminal_form" style="display:none;">
                            <form action="/kom/xband/fixedterminal" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="manpack" value ="manpack">Manpack</option>
                                <option id="fixedterminal" value="fixedterminal">Fixed Terminal</option>
                        ...
                        <!-- --------------------------------NavalTerminal FORM------------------------------------ -->
                        <div id="navalterminal_form" style="display:none;">
                            <form action="/kom/xband/navalterminal" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="manpack" value ="manpack">Manpack</option>
                                <option id="fixedterminal" value="fixedterminal">Fixed Terminal</option>
                        ...
                        <!-- --------------------------------------------------------------COTP------------------------------------------------------------ -->
                        <div id="cotp_form" style="display:none;">
                            <form action="/kom/xband/cotp" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="manpack" value ="manpack">Manpack</option>
                                <option id="fixedterminal" value="fixedterminal">Fixed Terminal</option>
                        ...
                        <!-- ---------------------------------------COTM    ------------------------------ -->
                        <div id="cotm_form" style="display:none;">
                            <form action="/kom/xband/cotm" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="manpack" value ="manpack">Manpack</option>
                                <option id="fixedterminal" value="fixedterminal">Fixed Terminal</option>
                        ...
                        <!-- -------------------------------------------flyawaykit-------------------------------------------- -->
                        <div id="flyawaykit_form" style="display:none;">
                            <form action="/kom/xband/flyawaykit" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="manpack" value ="manpack">Manpack</option>
                                <option id="fixedterminal" value="fixedterminal">Fixed Terminal</option>
