...
<script>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col">
                ...
                <tbody style="text-align: center">
                    ...
                    <tr>
                        <td>{{ $data->lokasi}}</td>
                        <td>
                            <a href="/kom/sistemict/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                            <a href="/kom/sistemict/edit/{{ $data->id }}" class="btn btn-danger">Edit</a>
                        </td>
                        {{-- <td><a href="/kom/sistemict/{{ $data->id }}"><i class="material-icons">&#xE254;</i></a>
                            <form method="post" action="/kom/sistemict/{{ $data->id }}">
                                @csrf
                                @method('delete')
            ...
            <a href="/kom/sistemict/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
