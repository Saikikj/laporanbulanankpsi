...
<script>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('NETWORK CENTRIC OPERATION') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>Network Centric Operation <b>(NCO)</b></h2></div>
                                <div class="col-sm-4">
                ...
                <thead style="text-align: center">
                    ...
                    <tr>
                        <th rowspan="2">Pangkalan/Kapal</th>
                ...
                <tbody style="text-align: center">
                    @foreach ($datas as $data)
                            <tr>
                                <td>{{ $data->kapalpangkalan}}</td>
                                <td>{{ $data->nco}}</td>
                                <td>{{ $data->baik }}</td>
                                <td>{{ $data->rosak }}</td>
                                <td>{{ $data->catatan }}</td>
                        <td>
                            <a href="/kom/nco/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                            <a href="/kom/nco/edit/{{ $data->id }}" class="btn btn-danger">Edit</a>
                        </td>
                                {{-- <td><a href="/kom/nco/{{ $data->id }}"><i class="material-icons">&#xE254;</i></a>
                                    <form method="post" action="/kom/nco/{{ $data->id }}">
                                        @csrf
                                        @method('delete')
            ...
            <a href="/kom/nco/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
