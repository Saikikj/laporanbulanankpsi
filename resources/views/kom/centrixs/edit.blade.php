...
<!-- --------------------------show and hide script --------------------------- -->
        ...
        $(function() {
        $("#peralatan_select").change(function() {
            if ($("#rekodpenggunaan").is(":selected")) {
            $("#rekodpenggunaan_form").show();
            // $("#rekodpenggunaan_form").hide();
            } else {
            $("#rekodpenggunaan_form").hide();
            // $("#rekodpenggunaan_form").show();
            }
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan CENTRIXS</h3></div>
                                <!-- <div class="col-sm-4">
...
<!-- ---------------------------------------------END OF TEST SHOW/HIDE---------------------------------------------------- -->
                            ...
                            <div>&nbsp</div>
<form action="/kom/centrixs/update/{{$data->id}}" method="POST" id="userformcreate">
@csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="markas" type="text"
                                            class="form-control @error('markas') is-invalid @enderror" name="markas"
                                            value="{{ $data->markas }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="fitted" type="text"
                                            ...
                                            value="{{ $data->markas }}" placeholder="Jumlah Fitted" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="flywaykit" type="text"
                                            class="form-control @error('flywaykit') is-invalid @enderror" name="flywaykit"
                                            value="{{ $data->flywaykit }}" placeholder="Jumlah Rosak" required>
                                    </div>
                                </div>
