...
<!-- -----------------------------------------------------END OF CSS AND SCRIPT SECTIONS---------------------------------------------- -->
       <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('C4ITacX') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan C4ITacX </h3></div>
                                <!-- <div class="col-sm-4">
...
<div id="kapal_form" style="display:none;">
    <form action="/kom/c4itacx/kapal" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="kapal" value ="kapal">KAPAL</option>
        <option id="pangkalan" value="pangkalan">PANGKALAN</option>
    </select>
                                <div class="form-group row">
                                    <label for="kapal"
                                        class="col-md-4 col-form-label text-md-right">{{ __('Kapal') }}</label>

                                    <div class="col-md-6">
                                        <input id="t" type="text"
                                            class="form-control @error('kapal') is-invalid @enderror" name="kapal"
                                            value="{{ old('kapal') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="c4itacx"
                                        class="col-md-4 col-form-label text-md-right">{{ __('C4ITacX') }}</label>

                                    <div class="col-md-6">
                                        <input id="c4itacx" type="text"
                                            class="form-control @error('c4itacx') is-invalid @enderror" name="c4itacx"
                                            value="{{ old('c4itacx') }}"  required>
                                    </div>
                                </div>
...
<!-- --------------------------------PRINTER FORM------------------------------------ -->
<div id="pangkalan_form" style="display:none;">
    <form action="/kom/c4itacx/pangkalan" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="kapal" value ="kapal">KAPAL</option>
        <option id="pangkalan" value="pangkalan">PANGKALAN</option>
                        ...
                        <a href="/kom/c4itacx"><button type="button" class="btn btn-default">Back</button>
