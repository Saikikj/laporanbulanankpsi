...
<!-- --------------------------------PRINTER FORM------------------------------------ -->
<form action="/kom/fbb/updateSimkad/{{$data->id}}" method="POST" id="userformcreate">
    @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="markasunit" type="text"
                                            ...
                                            value="{{ $data->markasunit }}" required>
                                    </div>
                                </div>
                                ...
                                <label for="pakejlangganan"
                                    ...
                                    <div class="col-md-6">
                                        <input id="pakejlangganan" type="text"
                                            ...
                                            value="{{ $data->pakejlangganan }}"  required>
                                    </div>
                                </div>
