...
<!-- -----------------------------------------------------END OF CSS AND SCRIPT SECTIONS---------------------------------------------- -->
       <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('TERMINAL X-BAND') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Terminal X-BAND</h3></div>
                                <!-- <div class="col-sm-4">
...
<!-- -----------------------------------------------------TEST SHOW/HIDE--------------------------------------------------- -->
    ...
    <option id="manpack">Manpack</option>
    <option id="fixedterminal">Fixed Terminal</option>
    <option id="navalterminal">Naval Terminal</option>
    <option id="cotp">COTP</option>
    <option id="cotm">COTM</option>
    <option id="flyawaykit">Flyaway Kit</option>
