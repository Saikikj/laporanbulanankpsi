            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button class="collapsible" style="text-align:center">Manpack</button>
                        <div class="content">
                            <table class="table table-bordered">
                                <tbody style="text-align: center">
                                    <tr>
                                        <th rowspan="1">Penempatan</th>
                                    ...
                                    @foreach ($datamanpack as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                        <td>
                            <a href="/kom/xband/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                            <a href="/kom/xband/edit/{{ $data->id }}" class="btn btn-danger">Edit</a>
                        </td>
                                            {{-- <td><a href="/kom/xband/{{ $data->id }}"><i class="material-icons">&#xE254;</i></a>
                                                <form method="post" action="/kom/xband/{{ $data->id }}">
                                                    @csrf
                                                    @method('delete')
                        ...
                        <button class="collapsible" style="text-align:center">Fixed Terminal</button>
                        <div class="content">
                            <table class="table table-bordered">
                                <tbody style="text-align: center">
                                    <tr>
                                    ...
                                    @foreach ($datafixedterminal as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                        <td>
                            <a href="/kom/xband/deleteFixedterminal/{{ $data->id }}" class="btn btn-danger">Delete</a>
                            <a href="/kom/xband/editFixedterminal/{{ $data->id }}" class="btn btn-danger">Edit</a>
                        </td>
                                            {{-- <td><a href="/kom/xband/{{ $data->id }}"><i class="material-icons">&#xE254;</i></a>
                                                <form method="post" action="/kom/xband/{{ $data->id }}">
                                                    @csrf
                        ...
                        <button class="collapsible" style="text-align:center">Naval Terminal</button>
                        <div class="content">
                            <table class="table table-bordered">
                                <tbody style="text-align: center">
                                    <tr>
                                    ...
                                    @foreach ($datanavalterminal as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                        <td>
                            <a href="/kom/xband/deleteNavalterminal/{{ $data->id }}" class="btn btn-danger">Delete</a>
                            <a href="/kom/xband/editNavalterminal/{{ $data->id }}" class="btn btn-danger">Edit</a>
                        </td>
                                            {{-- <td><a href="/kom/xband/{{ $data->id }}"><i class="material-icons">&#xE254;</i></a>
                                                <form method="post" action="/kom/xband/{{ $data->id }}">
                                                    @csrf
                        ...
                        <button class="collapsible" style="text-align:center">COTP</button>
                        <div class="content">
                            <table class="table table-bordered">
                                <tbody style="text-align: center">
                                    <tr>
                                    ...
                                    @foreach ($datacotp as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                        <td>
                            <a href="/kom/xband/deleteCotp/{{ $data->id }}" class="btn btn-danger">Delete</a>
                            <a href="/kom/xband/editCotp/{{ $data->id }}" class="btn btn-danger">Edit</a>
                        </td>
                                            {{-- <td><a href="/kom/xband/{{ $data->id }}"><i class="material-icons">&#xE254;</i></a>
                                                <form method="post" action="/kom/xband/{{ $data->id }}">
                                                    @csrf
                        ...
                        <button class="collapsible" style="text-align:center">COTM</button>
                        <div class="content">
                            <table class="table table-bordered">
                                <tbody style="text-align: center">
                                    <tr>
                                    ...
                                    @foreach ($datacotm as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                        <td>
                            <a href="/kom/xband/deleteCotm/{{ $data->id }}" class="btn btn-danger">Delete</a>
                            <a href="/kom/xband/editCotm/{{ $data->id }}" class="btn btn-danger">Edit</a>
                        </td>
                                            {{-- <td><a href="/kom/xband/{{ $data->id }}"><i class="material-icons">&#xE254;</i></a>
                                                <form method="post" action="/kom/xband/{{ $data->id }}">
                                                    @csrf
                        ...
                        <button class="collapsible" style="text-align:center">Flyaway Kit</button>
                        <div class="content">
                            <table class="table table-bordered">
                                <tbody style="text-align: center">
                                    <tr>
                                    ...
                                    @foreach ($dataflyawaykit as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                        <td>
                            <a href="/kom/xband/deleteFlyawaykit/{{ $data->id }}" class="btn btn-danger">Delete</a>
                            <a href="/kom/xband/editFlyawaykit/{{ $data->id }}" class="btn btn-danger">Edit</a>
                        </td>
                                            {{-- <td><a href="/kom/xband/{{ $data->id }}"><i class="material-icons">&#xE254;</i></a>
                                                <form method="post" action="/kom/xband/{{ $data->id }}">
                                                    @csrf
                        ...
                        <a href="/kom/index"><button type="button" class="btn btn-default">Back</button>
                            <a href="/kom/index"><button type="button" class="btn btn-default">Home</button>
                                <a href="/kom/xband/addnew"><button type="button" class="btn btn-default"
