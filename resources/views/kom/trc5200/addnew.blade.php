...
<!-- -----------------------------------------------------END OF CSS AND SCRIPT SECTIONS---------------------------------------------- -->
       <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('TRC5200') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini TRC 5200 </h3></div>
                                <!-- <div class="col-sm-4">
...
<!-- ---------------------------------------------END OF TEST SHOW/HIDE---------------------------------------------------- -->
                            ...
                            <div>&nbsp</div>
<form action="/kom/trc5200" method="POST" id="userformcreate">
    @csrf
                                <div class="form-group row">
                                    <label for="namakapalunit"
                                        class="col-md-4 col-form-label text-md-right">{{ __('Nama Kapal/Unit') }}</label>

                                    <div class="col-md-6">
                                        <input id="namakapalunit" type="text"
                                            class="form-control @error('namakapalunit') is-invalid @enderror" name="namakapalunit"
                                            value="{{ old('namakapalunit') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="bft"
                                        class="col-md-4 col-form-label text-md-right">{{ __('BFT') }}</label>

                                    <div class="col-md-6">
                                        <input id="bft" type="text"
                                            class="form-control @error('bft') is-invalid @enderror" name="bft"
                                            value="{{ old('bft') }}"  required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="handheld"
                                        class="col-md-4 col-form-label text-md-right">{{ __('HANDHELD') }}</label>

                                    <div class="col-md-6">
                                        <input id="handheld" type="text"
                                            class="form-control @error('handheld') is-invalid @enderror" name="handheld"
                                            value="{{ old('handheld') }}"  required>
                                    </div>
                                </div>
