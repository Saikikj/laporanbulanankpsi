...
<!-- -----------------------------------------------------END OF CSS AND SCRIPT SECTIONS---------------------------------------------- -->
       <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('KAT 2100 SK700') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan KAT 2100 SK700 </h3></div>
                                <!-- <div class="col-sm-4">
...
<!-- ---------------------------------------------END OF TEST SHOW/HIDE---------------------------------------------------- -->
                            ...
                            <div>&nbsp</div>
                            <form action="/kom/kat/update/{{$data->id}}" method="POST" id="userformcreate">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label for="kat2100"
                                        class="col-md-4 col-form-label text-md-right">{{ __('KAT 2100') }}</label>

                                    <div class="col-md-6">
                                        <input id="kat2100" type="text"
                                            class="form-control @error('kat2100') is-invalid @enderror" name="kat2100"
                                            value="{{ $data->kat2100 }}"  required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="kat3100"
                                        class="col-md-4 col-form-label text-md-right">{{ __('KAT 3100') }}</label>

                                    <div class="col-md-6">
                                        <input id="kat3100" type="text"
                                            class="form-control @error('kat3100') is-invalid @enderror" name="kat3100"
                                            value="{{ $data->kat3100 }}"  required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="kat3200"
                                        class="col-md-4 col-form-label text-md-right">{{ __('KAT 3200') }}</label>

                                    <div class="col-md-6">
                                        <input id="kat3200" type="text"
                                            class="form-control @error('kat3200') is-invalid @enderror" name="kat3200"
                                            value="{{ $data->kat3200 }}"  required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="kat3300"
                                        class="col-md-4 col-form-label text-md-right">{{ __('KAT 3300') }}</label>

                                    <div class="col-md-6">
                                        <input id="kat3300" type="text"
                                            class="form-control @error('kat3300') is-invalid @enderror" name="kat3300"
                                            value="{{ $data->kat3300 }}"  required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="skm700"
                                        class="col-md-4 col-form-label text-md-right">{{ __('SKM 700') }}</label>

                                    <div class="col-md-6">
                                        <input id="skm700" type="text"
                                            class="form-control @error('skm700') is-invalid @enderror" name="skm700"
                                            value="{{ $data->skm700 }}"  required>
                                    </div>
                                </div>
