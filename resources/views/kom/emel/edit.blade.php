...
<!-- -----------------------------------------------------END OF CSS AND SCRIPT SECTIONS---------------------------------------------- -->
       <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('EMEL RASMI TLDM') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>EMEL RASMI TLDM</h3></div>
                                <!-- <div class="col-sm-4">
...
<!-- ---------------------------------------------END OF TEST SHOW/HIDE---------------------------------------------------- -->
                            ...
                            <div>&nbsp</div>
<form action="/kom/emel/update/{{$data->id}}" method="POST" id="userformcreate">
@csrf
                                ...
                                <div class="form-group row">
                                    <label for="sever"
                                        class="col-md-4 col-form-label text-md-right">{{ __('Server') }}</label>

                                    <div class="col-md-6">
                                        <input id="sever" type="text"
                                            class="form-control @error('sever') is-invalid @enderror" name="sever"
                                            value="{{ $data->sever }}" required>
                                    </div>
                                </div>
                        ...
                        <a href="/kom/emel"><button type="button" class="btn btn-default">Back</button>
