                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan NCO </h3></div>
                                <!-- <div class="col-sm-4">
...
<!-- ---------------------------------------------END OF TEST SHOW/HIDE---------------------------------------------------- -->
                            ...
                            <div>&nbsp</div>
    <form action="/kom/nco/update/{{$data->id}}" method="POST" id="userformcreate">
        @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="kapalpangkalan" type="text"
                                            class="form-control @error('kapalpangkalan') is-invalid @enderror" name="kapalpangkalan"
                                            value="{{ $data->kapalpangkalan }}" required>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="nco"
                                        class="col-md-4 col-form-label text-md-right">{{ __('NCO ') }}</label>

                                    <div class="col-md-6">
                                        <input id="nco" type="text"
                                            class="form-control @error('nco') is-invalid @enderror" name="nco"
                                            value="{{$data->nco }}" required>
                                    </div>
                                </div>
                        ...
                        <a href="/kom/nco"><button type="button" class="btn btn-default">Back</button>
