    ...
    $(document).ready(function(){
       ...
       <div class="container">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('ALAT KRIPTO ATM DAN TLDM') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                ...
                <thead style="text-align: center">
                    ...
                    <tr>
                        ...
                        <th rowspan="2">KAT <br>3100</th>
                        <th rowspan="2">KAT <br>3200</th>
                        <th rowspan="2">KAT <br>3300</th>
                        <th rowspan="2">SKM <br>700</th>
