...
<!-- -----------------------------------------------------END OF CSS AND SCRIPT SECTIONS---------------------------------------------- -->
       <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('KOMUNIKASI SATELIT') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>KOMUNIKASI SATELIT</h3></div>
                                <!-- <div class="col-sm-4">
...
<!-- ---------------------------------------------END OF TEST SHOW/HIDE---------------------------------------------------- -->
                            ...
                            <div>&nbsp</div>
                            <form action="/kom/satcom/update/{{$data->id}}" method="POST" id="userformcreate">
                                @csrf
                                <div class="form-group row">
                                    <label for="rangkaian"
                                        class="col-md-4 col-form-label text-md-right">{{ __('Rangkaian') }}</label>

                                    <div class="col-md-6">
                                        <input id="rangkaian" type="text"
                                            class="form-control @error('rangkaian') is-invalid @enderror" name="rangkaian"
                                            value="{{ $data->rangkaian }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="jumlahpeganganterminal" type="text"
                                            ...
                                            value="{{ $data->jumlahpeganganterminal }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="baik"
                        ...
                        <a href="/kom/satcom"><button type="button" class="btn btn-default">Back</button>
