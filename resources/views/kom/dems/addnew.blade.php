...
<!-- ---------------------------------------------END OF TEST SHOW/HIDE---------------------------------------------------- -->
                            ...
                            <div>&nbsp</div>
<div id="peralatandems_form" style="display:none;">
    <form action="/kom/dems/peralatandems" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="peralatandems" value ="peralatandems">Peralatan DEMS</option>
        <option id="cadangan" value="cadangan">Cadangan</option>
    </select>
...
<!-- --------------------------------PRINTER FORM------------------------------------ -->
<div id="cadangan_form" style="display:none;">
    <form action="/kom/dems/cadangan" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="peralatandems" value ="peralatandems">Peralatan DEMS</option>
        <option id="cadangan" value="cadangan">Cadangan</option>
