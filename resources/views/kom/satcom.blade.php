        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>KOMUNIKASI <b>SATELIT</b></h2></div>
                                <div class="col-sm-4">
                ...
                <thead style="text-align: center">
                    <tr>
                        <th colspan="12">Status Peralatan</th>
                    </tr>
                    <tr>
                        <th rowspan="2">Rangkaian</th>
                ...
                <tbody style="text-align: center">
                    @foreach ($datas as $data)
                            <tr>
                                <td>{{ $data->rangkaian}}</td>
                                <td>{{ $data->jumlahpeganganterminal}}</td>
                                <td>{{ $data->baik }}</td>
                                <td>{{ $data->rosak }}</td>
                                <td>{{ $data->catatan }}</td>
                        <td>
                            <a href="/kom/satcom/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                            <a href="/kom/satcom/edit/{{ $data->id }}" class="btn btn-danger">Edit</a>
                        </td>
                                {{-- <td><a href="/kom/satcom/{{ $data->id }}"><i class="material-icons">&#xE254;</i></a>
                                    <form method="post" action="/kom/satcom/{{ $data->id }}">
                                        @csrf
                                        @method('delete')
            ...
            <a href="/kom/satcom/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
