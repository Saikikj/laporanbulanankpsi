...
<script>
    ...
    <div class="container">
        <div class="row justify-content-center">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>EMEL RASMI TLDM</h2></div>
                                <div class="col-sm-4">
                ...
                <tbody style="text-align: center">
                    @foreach ($datas as $data)
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                        <td>
                            <a href="/kom/emel/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                            <a href="/kom/emel/edit/{{ $data->id }}" class="btn btn-danger">Edit</a>
                        </td>
                                {{-- <td><a href="/kom/emel/{{ $data->id }}"><i class="material-icons">&#xE254;</i></a>
                                    <form method="post" action="/kom/emel/{{ $data->id }}">
                                        @csrf
                                        @method('delete')
            ...
            <a href="/kom/emel/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
