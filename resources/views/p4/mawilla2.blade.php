                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Peralatan P4 Markas Wilayah Laut 2</h3></div>
    ...
    <div class="scrollmenu">
                    <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mawilla2/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mawilla2/edit/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <table class="table table-bordered">
                            ...
                            @foreach ($datalaptop as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->catatan }}</td>
                                    <td>
                                        <a href="/p4/mawilla2/deleteLaptop/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                        <a href="/p4/mawilla2/editLaptop/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
...
<div class="content">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mawilla2/deletePrinter/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mawilla2/editPrinter/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
...
<button class="collapsible" style="text-align:center">Peralatan Sokongan</button>
<div class="content">
                        <table class="table table-bordered">
                            <tbody style="text-align: center">
                            <tr>
                                ...
                                <th rowspan="1">Pangkat</th>
                                <th rowspan="1">TRED</th>
                                <th rowspan="1">Kategori Peralatan</th>
                                <th rowspan="1">Lokasi</th>
                                <th rowspan="1">No. Siri</th>
                                <th rowspan="1">Jenama</th>
                                <th rowspan="1">Toner</th>
                            ...
                            @foreach ($dataperalatansokong as $data)
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mawilla2/deletePeralatansokong/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mawilla2/editPeralatansokong/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                        ...
                        <a href="/p4/mawilla2/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
