...
<!-- ------------------------------------------------ Komputer Meja ----------------------------------------- -->
                            ...
                            <div>&nbsp</div>
    <form action="/p4/mawilla2/updatePeralatansokong/{{$data->id}}" method="POST" id="userformcreate">
        @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="notentera" type="text"
                                            ...
                                            value="{{ $data->notentera }}" placeholder="N/xxxxxx atau NV/xxxxxx" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                <label for="pangkat"
