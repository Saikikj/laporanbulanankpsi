                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h3>Peralatan P4 Markas Wilayah Laut 1</h3>
                                </div>
                                    ...
                                    <tbody style="text-align: center">
                                        ...
                                        @foreach ($datapc as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->catatan }}</td>
                                                <td>
                                                    <a href="/p4/mawilla1/delete/{{ $data->id }}"
                                                        class="btn btn-danger">Delete</a>
                                                    <a href="/p4/mawilla1/edit/{{ $data->id }}"
                                ...
                                <tbody style="text-align: center">
                                    ...
                                    @foreach ($datalaptop as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                                            <td>
                                                <a href="/p4/mawilla1/deleteLaptop/{{ $data->id }}"
                                                    class="btn btn-danger">Delete</a>
                                                <a href="/p4/mawilla1/editLaptop/{{ $data->id }}"
                                                    class="btn btn-danger">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                <tbody style="text-align: center">
                                    ...
                                    @foreach ($dataprinter as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                                            <td>
                                                <a href="/p4/mawilla1/deletePrinter/{{ $data->id }}"
                                                    class="btn btn-danger">Delete</a>
                                                <a href="/p4/mawilla1/editPrinter/{{ $data->id }}"
                                                    class="btn btn-danger">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                <tbody style="text-align: center">
                                    ...
                                    @foreach ($datavtc as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                                            <td>
                                                <a href="/p4/mawilla1/deleteVtc/{{ $data->id }}"
                                                    class="btn btn-danger">Delete</a>
                                                <a href="/p4/mawilla1/editVtc/{{ $data->id }}"
                                                    class="btn btn-danger">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                <tbody style="text-align: center">
                                    ...
                                    @foreach ($dataswitchrouter as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                                            <td>
                                                <a href="/p4/mawilla1/deleteSwitchrouter/{{ $data->id }}"
                                                    class="btn btn-danger">Delete</a>
                                                <a href="/p4/mawilla1/editSwitchrouter/{{ $data->id }}"
                                                    class="btn btn-danger">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                <tbody style="text-align: center">
                                    ...
                                    @foreach ($dataancillaries as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->catatan }}</td>
                                            <td>
                                                <a href="/p4/mawilla1/deleteAncillaries/{{ $data->id }}"
                                                    class="btn btn-danger">Delete</a>
                                                <a href="/p4/mawilla1/editAncillaries/{{ $data->id }}"
                                                    class="btn btn-danger">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <div class="content">
                            <table class="table table-bordered">
                                <tbody style="text-align: center">
                                    <tr>
                                        <th rowspan="1">Peralatan</th>
                                        <th rowspan="1">Jenis Peralatan</th>
                                        <th rowspan="1">No Siri</th>
                                        <th rowspan="1">Tahun</th>
                                        <th rowspan="1">Lokasi</th>
                                        <th rowspan="1">Status <br> (Baik/Rosak)</th>
                                    ...
                                    @foreach ($datacomm as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/p4/mawilla1/deleteComm/{{ $data->id }}"
                                                    class="btn btn-danger">Delete</a>
                                                <a href="/p4/mawilla1/editComm/{{ $data->id }}"
                                                    class="btn btn-danger">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <a href="/p4/index"><button type="button" class="btn btn-default">Back</button>
                            <a href="/p4/index"><button type="button" class="btn btn-default">Home</button>
                                <a href="/p4/mawilla1/addnew"><button type="button" class="btn btn-default"
