...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('MARKAS PEMERINTAHAN ARMADA TIMUR') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h3>Kemaskini Peralatan Markas Pemerintahan Armada Timur</h3>
                                </div>
                                <!-- <div class="col-sm-4">
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                ...
                                <div id="PC_form" style="display:none;">
                                    <form action="/p4/mpat/pc" method="POST" id="userformcreate">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="bilcpu" type="number"
                                                    class="form-control @error('bilcpu') is-invalid @enderror"
                                                    name="bilcpu" value="{{ old('bilcpu') }}"
                                                    placeholder="Bilangan Monitor" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="bilmonitor" type="number"
                                                    class="form-control @error('bilmonitor') is-invalid @enderror"
                                                    name="bilmonitor" value="{{ old('bilmonitor') }}"
                                                    placeholder="Bilangan Monitor" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="bilmouse" type="number"
                                                    class="form-control @error('bilmouse') is-invalid @enderror"
                                                    name="bilmouse" value="{{ old('bilmouse') }}"
                                                    placeholder="Bilangan Mouse" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="bilkeyboard" type="number"
                                                    class="form-control @error('bilkeyboard') is-invalid @enderror"
                                                    name="bilkeyboard" value="{{ old('bilkeyboard') }}"
                                                    placeholder="Bilangan Monitor" required>
                                            </div>
                                        </div>
                                        ...
                                        <div id="">
                                            ...
                                            <div class="form-group row">
                                                <label for="linep4"
                                                    class="col-md-4 col-form-label text-md-right">{{ __('LINE P4') }}</label>

                                                <div class="col-md-6">
                                                    <select class="form-control @error('linep4') is-invalid @enderror"
                                                        name="linep4" value="{{ old('linep4') }}">
                                                        <option value="" disabled selected>Sila Pilih Status</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="namauser" type="text"
                                                        ...
                                                        name="namauser" value="{{ old('namauser') }}">
                                                </div>
                                            </div>
                                ...
                                <div id="laptop_form" style="display:none;">
                                    <form action="/p4/mpat/laptop" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="sistem" type="text"
                                                        class="form-control @error('sistem') is-invalid @enderror"
                                                        name="sistem" value="{{ old('sistem') }}">
                                                </div>
                                            </div>
                                ...
                                <div id="printer_form" style="display:none;">
                                    <form action="/p4/mpat/printer" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <div id="faksimili_form" style="display:none;">
                                    <form action="/p4/mpat/facsimile" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                        ...
                        <a href="/p4/mpat/"><button type="button" class="btn btn-default">Back</button>
