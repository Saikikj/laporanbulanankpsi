                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Peralatan P4 Pusat Hidrografi Nasional</h3></div>
    ...
    <div class="scrollmenu">
                    <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th rowspan="1">TLDMNET <br>(Ada/tiada)</th>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/phn/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/phn/edit/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
...
<div class="content">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/phn/deletePrinter/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/phn/editPrinter/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
...
<br>
                        ...
                        <a href="/p4/phn/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
