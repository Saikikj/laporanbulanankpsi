    ...
    <div class="scrollmenu">
                    <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mkpl/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mkpl/edit/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
...
<div class="content">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mkpl/deletePrinter/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mkpl/editPrinter/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
