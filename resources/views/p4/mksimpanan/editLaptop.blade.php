                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="container-fluid">
                            ...
                            <div>&nbsp</div>
    <form action="/p4/mksimpanan/updateLaptop/{{$data->id}}" method="POST" id="userformcreate">
        @csrf
                                ...
                                <label for="pangkat"
                                    ...
                                    <div class="col-md-6">
                                        <input id="pangkat" type="text"
                                            ...
                                            value="{{ $data->pangkat }}" placeholder="contoh: LT MUDA TLDM" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="antivirus" type= "text"
                                            ...
                                            value="{{ $data->antivirus }}" placeholder="tahun MS Office" required>
                                    </div>
                                </div>
