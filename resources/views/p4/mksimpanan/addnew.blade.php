                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan Markas Simpanan</h3></div>
                                <!-- <div class="col-sm-4">
...
<div id="PC_form" style="display:none;">
    <form action="/p4/mksimpanan/pc" method="POST" id="userformcreate">
        @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="antivirus" type= "text"
                                            ...
                                            value="{{ old('antivirus') }}" placeholder="tahun MS Office" required>
                                    </div>
                                </div>
...
<div id="laptop_form" style="display:none;">
    <form action="/p4/mksimpanan/laptop" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <label for="pangkat"
                                    ...
                                    <div class="col-md-6">
                                        <input id="pangkat" type="text"
                                            ...
                                            value="{{ old('pangkat') }}" placeholder="contoh: LT MUDA TLDM" required>
                                    </div>
                                </div>
...
<div id="printer_form" style="display:none;">
    <form action="/p4/mksimpanan/printer" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
...
<div id="vtc_form" style="display:none;">
    <form action="/p4/mksimpanan/vtc" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
...
<div id="switchrouter_form" style="display:none;">
    <form action="/p4/mksimpanan/switchrouter" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
...
<div id="ancillaries_form" style="display:none;">
    <form action="/p4/mksimpanan/ancillaries" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
...
<div id="comm_form" style="display:none;">
    <form action="/p4/mksimpanan/comm" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
        ...
        <option id="comm" value="comm">Comm</option>
                        ...
                        <a href="/p4/mksimpanan/"><button type="button" class="btn btn-default">Back</button>
