    ...
    $(document).ready(function(){
       ...
       <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('MARKAS PEMERINTAHAN KAPAL SELAM') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Peralatan P4 Markas Pemerintahan Kapal Selam</h3></div>
    ...
    <div class="scrollmenu">
                    <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mpks/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mpks/edit/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
...
<div class="content">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mpks/deletePrinter/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mpks/editPrinter/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                            </tbody>
...
<div class="content">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mpks/deleteFacsimile/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mpks/editFacsimile/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                            </tbody>
...
<div class="content">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th rowspan="1">Tahun</th>
                                <th rowspan="1">Status <br> (Baik/Rosak)</th>
                                <th rowspan="1">No. Rujukan Kewpa</th>
                                <th rowspan="1">Catatan</th>
                                <th rowspan="1">Tindakan</th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mpks/deleteTelephone/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mpks/editTelephone/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
...
<table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mpks/deleteSwitchrouter/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mpks/editSwitchrouter/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
...
<button class="collapsible" style="text-align:center">VC</button>
<div class="content">
                        <table class="table table-bordered">
                            <tbody style="text-align: center">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mpks/deleteVc/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mpks/editVc/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
...
<button class="collapsible" style="text-align:center">Lain-Lain Peralatan</button>
<div class="content">
                        <table class="table table-bordered">
                            <tbody style="text-align: center">
                            <tr>
                            ...
                            @foreach ($datalainperalatan as $data)
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                <td>
                                    <a href="/p4/mpks/deleteLainperalatan/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                    <a href="/p4/mpks/editLainperalatan/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        @endforeach
...
<br>
                        ...
                        <a href="/p4/mpks/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
