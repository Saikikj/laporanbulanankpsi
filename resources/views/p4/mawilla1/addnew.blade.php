                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h3>Kemaskini Peralatan Markas Wilayah Laut 1</h3>
                                </div>
                                <!-- <div class="col-sm-4">
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div>&nbsp</div>
                                <form action="/p4/mawilla1/pc" method="POST" id="userformcreate">
                                    @csrf
                                    ...
                                    <option id="ancillaries" value="ancillaries">Ancillaries</option>
                                    <option id="comm" value="comm">Comm</option>
                                </select>
                        ...
                        <div id="laptop_form" style="display:none;">
                            <form action="/p4/mawilla1/laptop" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="PC" value ="PC">Komputer Meja</option>
                                <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                            ...
                                            <option value="KD PERDANA">KD PERDANA</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="nama" type="text"
                                                ...
                                                value="{{ old('nama') }}" placeholder="Nama pengguna peralatan"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="namauser" type="text"
                                                ...
                                                name="namauser" value="{{ old('namauser') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control @error('operatingsystem') is-invalid @enderror"
                                                name="operatingsystem" value="{{ old('operatingsystem') }}">
                                                <option value="" disabled selected>Sila Pilih Operating System
                                                </option>
                                                <option value="win7">Windows 7</option>
                                                <option value="win8">Windows 8</option>
                                                <option value="win10">Windows 10</option>
                                    ...
                                    <div class="form-group row mb-0"><label for="unit">
                                        <div class="col-md-6 offset-md-4">
                                            <button type="submit" style="width:auto" class="btn btn-primary">
                                                {{ __('Tambah') }}</button>
                                            <button type="reset" style="width:auto" class="btn btn-primary">
                        ...
                        <div id="printer_form" style="display:none;">
                            <form action="/p4/mawilla1/printer" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="PC" value ="PC">Komputer Meja</option>
                                <option id="laptop" value="laptop">Komputer Riba</option>
                        ...
                        <div id="vtc_form" style="display:none;">
                            <form action="/p4/mawilla1/vtc" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="PC" value ="PC">Komputer Meja</option>
                                <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosiricodec" type="text"
                                            class="form-control @error('nosiricodec') is-invalid @enderror"
                                            name="nosiricodec" value="{{ old('nosiricodec') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosirimikrofon" type="text"
                                            class="form-control @error('nosirimikrofon') is-invalid @enderror"
                                            name="nosirimikrofon" value="{{ old('nosirimikrofon') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosiricamera" type="text"
                                            class="form-control @error('nosiricamera') is-invalid @enderror"
                                            name="nosiricamera" value="{{ old('nosiricamera') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosiriremote" type="text"
                                            class="form-control @error('nosiriremote') is-invalid @enderror"
                                            name="nosiriremote" value="{{ old('nosiriremote') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="poweradapter" type="text"
                                            class="form-control @error('poweradapter') is-invalid @enderror"
                                            name="poweradapter" value="{{ old('poweradapter') }}" required>
                                    </div>
                                </div>
                        ...
                        <div id="switchrouter_form" style="display:none;">
                            <form action="/p4/mawilla1/switchrouter" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="PC" value ="PC">Komputer Meja</option>
                                <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="peralatan" type="text"
                                            ...
                                            name="peralatan" value="{{ old('peralatan') }}" placeholder="Peralatan"
                                            required>
                                    </div>
                                </div>
                        ...
                        <div id="ancillaries_form" style="display:none;">
                            <form action="/p4/mawilla1/ancillaries" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="PC" value ="PC">Komputer Meja</option>
                                <option id="laptop" value="laptop">Komputer Riba</option>
                        ...
                        <div id="comm_form" style="display:none;">
                            <form action="/p4/mawilla1/comm" method="POST" id="userformcreate">
                                @csrf
                                <select name="peralatan_select" id="peralatan_select">
                                <option id="PC" value ="PC">Komputer Meja</option>
                                <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="jenistelephone" type="text"
                                            class="form-control @error('jenistelephone') is-invalid @enderror"
                                            name="jenistelephone" value="{{ old('jenistelephone') }}"
                                            placeholder="Jenis Telephone digunakan" required>
                                    </div>
                                </div>
