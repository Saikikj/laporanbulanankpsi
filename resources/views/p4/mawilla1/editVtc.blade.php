                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div>&nbsp</div>
<form action="/p4/mawilla1/updateVtc/{{$data->id}}" method="POST" id="userformcreate">
@csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosiricodec" type="text"
                                            ...
                                            name="nosiricodec" value="{{ $data->nosiricodec }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosirimikrofon" type="text"
                                            ...
                                            name="nosirimikrofon" value="{{ $data->nosirimikrofon }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosiricamera" type="text"
                                            ...
                                            name="nosiricamera" value="{{ $data->nosiricamera }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosiriremote" type="text"
                                            ...
                                            name="nosiriremote" value="{{ $data->nosiriremote }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="poweradapter" type="text"
                                            ...
                                            name="poweradapter" value="{{ $data->poweradapter }}" required>
                                    </div>
                                </div>
