                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div>&nbsp</div>
                <form action="/p4/mawilla1/updateComm/{{$data->id}}" method="POST" id="userformcreate">
                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="peralatan" type="text"
                                            ...
                                            name="peralatan" value="{{ $data->peralatan }}" placeholder="Peralatan"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="jenistelephone" type="text"
                                            ...
                                            name="jenistelephone" value="{{ $data->jenistelephone }}"
