...
<form action="/p4/mawilla1/updateLaptop/{{$data->id}}" method="POST" id="userformcreate">
@csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="perjawatan" type="text"
                                                ...
                                                name="perjawatan" value="{{ $data->perjawatan }}"
                                        ...
                                        <label for="pangkat"
                                            ...
                                            <div class="col-md-6">
                                                <input id="pangkat" type="text"
                                                    ...
                                                    name="pangkat" value="{{ $data->pangkat }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="nama" type="text"
                                                ...
                                                value="{{ $data->nama }}" placeholder="Nama pengguna peralatan"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="sistem" type="text"
                                                ...
                                                value="{{$data->sistem }}" placeholder="Sistem Peralatan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="namauser" type="text"
                                                ...
                                                name="namauser" value="{{ $data->namauser }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control @error('operatingsystem') is-invalid @enderror"
                                                name="operatingsystem" value="{{ $data->operatingystem }}">
