                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div>&nbsp</div>
<form action="/p4/mawilla1/update/{{$data->id}}" method="POST" id="userformcreate">
@csrf
                                            ...
                                            <label for="unit"
                                                ...
                                                <div class="col-md-6">
                                                    <input id="unit" type="text"
                                                        ...
                                                        name="unit" value="{{ $data->unit }}" required>
                                                </div>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="nosiricpu" type="text"
                                                        ...
                                                        name="nosiricpu" value="{{ $data->nosiricpu }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="ram" type="text"
                                                        ...
                                                        name="ram" value="{{ $data->ram }}" required>
                                                </div>
                                            </div>
