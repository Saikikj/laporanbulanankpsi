...
<div id="PC_form" style="display:none;">
    <form action="/p4/mawilla3/pc" method="POST" id="userformcreate">
        @csrf
        ...
        <option id="telephone" value="comm">Telephone</option>
    </select>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="unit" type="text"
                                            ...
                                            value="{{ old('unit') }}" placeholder="unit peralatan" required>
                                    </div>
                                </div>
...
<div id="laptop_form" style="display:none;">
    <form action="/p4/mawilla3/laptop" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
        ...
        <option id="telephone" value="comm">Telephone</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="namadaftar" type="text"
                                            class="form-control @error('namadaftar') is-invalid @enderror" name="namadaftar"
                                            value="{{ old('namadaftar') }}" placeholder = "Nama pengguna peralatan" required>
                                    </div>
                                </div>
...
<div id="printer_form" style="display:none;">
    <form action="/p4/mawilla3/printer" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
...
<div id="vtc_form" style="display:none;">
    <form action="/p4/mawilla3/vtc" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
...
<div id="switchrouter_form" style="display:none;">
    <form action="/p4/mawilla3/switchrouter" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
...
<div id="ancillaries_form" style="display:none;">
    <form action="/p4/mawilla3/ancillaries" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
...
<div id="telephone_form" style="display:none;">
    <form action="/p4/mawilla3/telephone" method="POST" id="userformcreate">
        @csrf
        <select name="peralatan_select" id="peralatan_select">
        <option id="PC" value ="PC">Komputer Meja</option>
        <option id="laptop" value="laptop">Komputer Riba</option>
