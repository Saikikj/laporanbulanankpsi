                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan Markas Wilayah Laut 3</h3></div>
                                <!-- <div class="col-sm-4">
...
<form action="/p4/mawilla3/updateLaptop/{{$data->id}}" method="POST" id="userformcreate">
@csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="unit" type="text"
                                            ...
                                            value="{{ $data->unit }}" placeholder="unit peralatan" required>
                                    </div>
                                </div>
                                ...
                                <label for="pangkat"
                                    ...
                                    <div class="col-md-6">
                                        <input id="pangkat" type="text"
                                            ...
                                            value="{{ $data->pangkat }}" placeholder="" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="namadaftar" type="text"
                                            ...
                                            value="{{ $data->namadaftar }}" placeholder = "Nama pengguna peralatan" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="processor" type="text"
                                            ...
                                            value="{{ $data->processor }}" placeholder="Processor peralatan" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="msoffice" type="text"
                                            ...
                                            value="{{ $data->msoffice }}" placeholder="tahun MS Office" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="antivirus" type="text"
                                            ...
                                            value="{{ $data->antivirus }}" placeholder="antivirus" required>
                                    </div>
                                </div>
...
<div id="printer_form" style="display:none;">
    <form action="/p4/mawilla3/updatePrinter/{{$data->id}}" method="POST" id="userformcreate">
        @csrf
                                <div class="form-group row">
                                        <label for="unit"
                                            class="col-md-4 col-form-label text-md-right">{{ __('Unit') }}</label>
...
<div id="vtc_form" style="display:none;">
    <form action="/p4/mawilla3/updateVtc/{{$data->id}}" method="POST" id="userformcreate">
        @csrf
                            <div class="form-group row">
                                    <label for="model"
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosiricodec" type="text"
                                            ...
                                            value="{{ $data->nosiricodec }}" required>
                                    </div>
                            </div>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosirimikrofon" type="text"
                                            ...
                                            value="{{ $data->nosirimikrofon }}" required>
                                    </div>
                            </div>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosiricamera" type="text"
                                            ...
                                            value="{{ $data->nosiricamera }}" required>
                                    </div>
                            </div>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosiriremote" type="text"
                                            ...
                                            value="{{ $data->nosiriremote }}" required>
                                    </div>
                            </div>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="poweradapter" type="text"
                                            ...
                                            value="{{ $data->poweradapter }}" required>
                                    </div>
                            </div>
...
<div id="switchrouter_form" style="display:none;">
    <form action="/p4/mawilla3/updateSwitchrouter/{{$data->id}}" method="POST" id="userformcreate">
        @csrf
                                <div class="form-group row">
                                    <label for="peralatan"
                                    ...
                                    <div class="col-md-6">
                                        <input id="peralatan" type="text"
                                            ...
                                            value="{{ $data->peralatan }}" placeholder="Peralatan" required>
                                    </div>
                                </div>
...
<div id="ancillaries_form" style="display:none;">
    <form action="/p4/mawilla3/updateAncillaries/{{$data->id}}" method="POST" id="userformcreate">
        @csrf
                            <div class="form-group row">
                                    <label for="peralatan"
                                        class="col-md-4 col-form-label text-md-right">{{ __('Peralatan') }}</label>
...
<div id="telephone_form" style="display:none;">
    <form action="/p4/mawilla3/updateTelephone/{{$data->id}}" method="POST" id="userformcreate">
        @csrf
                            <div class="form-group row">
                                    <label for="peralatan"
                                        class="col-md-4 col-form-label text-md-right">{{ __('Peralatan') }}</label>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="jenistelephone" type="text"
                                            ...
                                            value="{{ $data->jenistelephone }}" placeholder="Jenis Telephone digunakan" required>
                                    </div>
                            </div>
