...
<!-- -----------------------------------------------------TEST SHOW/HIDE--------------------------------------------------- -->
    ...
    <option id ="scanner">Pengimbas</option>
    ...
    <option id="foc">Fiber Optic Converter</option>
    <option id="acu">ACU</option>
    <option id="ups">UPS</option>
    <option id="sac">Security Access System</option>
    <option id="fas">Fire Alarm System</option>
    <option id="sg">Standby Generator</option>
