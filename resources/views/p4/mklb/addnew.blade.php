                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h3>Kemaskini Peralatan Markas Logistik Barat</h3>
                                </div>
                                <!-- <div class="col-sm-4">
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                ...
                                <div id="PC_form" style="display:none;">
                                    <form action="/p4/mklb/pc" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            ...
                                            <option id="faksimili" value="faksimili">Facsimile</option>
                                            <option id="switchrouter" value="switchrouter">Switch Router</option>
                                            <option id="foc" value="foc">Fiber Optic Converter</option>
                                            <option id="acu" value="acu">ACU</option>
                                            <option id="ups" value="ups">UPS</option>
                                            <option id="sac" value="sac">Security Access System</option>
                                            <option id="fas" value="fas">Fire Alarm System</option>
                                            <option id="sg" value="sg">Standby Generator
                                            </option>
                                        </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="perjawatan" type="text"
                                                    ...
                                                    name="perjawatan" value="{{ old('perjawatan') }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="notentera"
                                            ...
                                            <div class="col-md-6">
                                                <input id="notentera" type="text"
                                                    class="form-control @error('notentera') is-invalid @enderror"
                                                    name="notentera" value="{{ old('notentera') }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="pangkat"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="tred" type="text"
                                                    class="form-control @error('tred') is-invalid @enderror"
                                                    name="tred" value="{{ old('tred') }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="nama"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="nosirimonitor" type="text"
                                                    class="form-control @error('nosirimonitor') is-invalid @enderror"
                                                    name="nosirimonitor" value="{{ old('nosirimonitor') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control @error('terminalnc2') is-invalid @enderror"
                                                    name="terminalnc2" value="{{ old('terminalnc2') }}">
                                                    <option value="" disabled selected>Sila Pilih status</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="namadaftar" type="text"
                                                    class="form-control @error('namadaftar') is-invalid @enderror"
                                                    name="namadaftar" value="{{ old('namadaftar') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="processor" type="text"
                                                    ...
                                                    placeholder="Processor peralatan" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <select
                                                    class="form-control @error('operatingsystem') is-invalid @enderror"
                                                    name="operatingsystem" value="{{ old('operatingsystem') }}">
                                                    <option value="" disabled selected>Sila Pilih Operating
                                                        System</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="msoffice" type="text"
                                                    class="form-control @error('msoffice') is-invalid @enderror"
                                                    name="msoffice" value="{{ old('msoffice') }}"
                                                    placeholder="tahun MS Office" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="antivirus"
                                            ...
                                            <div class="col-md-6">
                                                <input id="antivirus" type="text"
                                                    class="form-control @error('antivirus') is-invalid @enderror"
                                                    name="antivirus" value="{{ old('antivirus') }}"
                                                    placeholder="Anti Virus" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="rujukankewpa" type="text"
                                                    class="form-control @error('rujukankewpa') is-invalid @enderror"
                                                    name="rujukankewpa" value="{{ old('rujukankewpa') }}"
                                                    placeholder="Rujukan Kewpa">
                                            </div>
                                        </div>
                                ...
                                <div id="laptop_form" style="display:none;">
                                    <form action="/p4/mklb/laptop" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="notentera" type="text"
                                                        class="form-control @error('notentera') is-invalid @enderror"
                                                        name="notentera" value="{{ old('notentera') }}"
                                                        placeholder="N/xxxxxx atau NV/xxxxxx" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="nama" type="text"
                                                        ...
                                                        placeholder="Nama pengguna peralatan" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="nosiri" type="text"
                                                        class="form-control @error('nosiri') is-invalid @enderror"
                                                        name="nosiri" value="{{ old('nosiri') }}"
                                                        placeholder="No Siri Peralatan" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="ram" type="text"
                                                        ...
                                                        placeholder="RAM peralatan" required>
                                                </div>
                                            </div>
                                ...
                                <div id="printer_form" style="display:none;">
                                    <form action="/p4/mklb/printer" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="lokasi" type="text"
                                                    ...
                                                    placeholder="Lokasi peralatan" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control @error('toner') is-invalid @enderror"
                                                    name="toner" value="{{ old('toner') }}">
                                ...
                                <!-- --------------------------------------------------------SCANNER --------------------------------------------------- -->
                                <div id="scanner_form" style="display:none;">
                                    <form action="/p4/mklb/scanner" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <div id="switchrouter_form" style="display:none;">
                                    <form action="/p4/mklb/switchrouter" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="perjawatan" type="text"
                                                    class="form-control @error('perjawatan') is-invalid @enderror"
                                                    name="perjawatan" value="{{ old('perjawatan') }}"
                                                    placeholder="Peralatan" required>
                                            </div>
                                        </div>
                                ...
                                <div id="faksimili_form" style="display:none;">
                                    <form action="/p4/mklb/facsimile" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <div id="foc_form" style="display:none;">
                                    <form action="/p4/mklb/fiber" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <!-- -------------------------------------------------------- ACU --------------------------------------------------- -->
                                <div id="acu_form" style="display:none;">
                                    <form action="/p4/mklb/acu" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <!-- -------------------------------------------------------- UPS --------------------------------------------------- -->
                                <div id="ups_form" style="display:none;">
                                    <form action="/p4/mklb/ups" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <div id="sac_form" style="display:none;">
                                    <form action="/p4/mklb/security" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <!-- -------------------------------------------------------- FIRE ALARM SYSTEM --------------------------------------------------- -->
                                <div id="fas_form" style="display:none;">
                                    <form action="/p4/mklb/fire" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
                                ...
                                <!-- -------------------------------------------------------- STANDBY GENERATOR --------------------------------------------------- -->
                                <div id="sg_form" style="display:none;">
                                    <form action="/p4/mklb/standbygenerator" method="POST" id="userformcreate">
                                        @csrf
                                        <select name="peralatan_select" id="peralatan_select">
                                            <option id="PC" value="PC">Komputer Meja</option>
                                            <option id="laptop" value="laptop">Komputer Riba</option>
