                    ...
                    <div class="card-body">
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                ...
                                <div>&nbsp</div>
                                <form action="/p4/mklb/update/{{ $data->id }}" method="POST" id="userformcreate">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="perjawatan" type="text"
                                                ...
                                                name="perjawatan" value="{{ $data->perjawatan }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="notentera"
                                        ...
                                        <div class="col-md-6">
                                            <input id="notentera" type="text"
                                                ...
                                                name="notentera" value="{{ $data->notentera }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="pangkat" type="text"
                                                ...
                                                name="pangkat" value="{{ $data->pangkat }}" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="nosiricpu" type="text"
                                                    ...
                                                    name="nosiricpu" value="{{ $data->nosiricpu }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="nosirimonitor" type="text"
                                                    ...
                                                    name="nosirimonitor" value="{{ $data->nosirimonitor }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control @error('terminalnc2') is-invalid @enderror"
                                                    name="terminalnc2" value="{{ $data->terminalnc2 }}">
                                                    {{-- <option value="" disabled selected>Sila Pilih status</option> --}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="namadaftar" type="text"
                                                    ...
                                                    name="namadaftar" value="{{ $data->namadaftar }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="processor" type="text"
                                                    ...
                                                    name="processor" value="{{ $data->processor }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="ram" type="text"
                                                    ...
                                                    value="{{ $data->ram }}" placeholder="RAM peralatan" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <select
                                                    ...
                                                    name="operatingsystem" value="{{ $data->operatingsystem }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="msoffice" type="text"
                                                    ...
                                                    name="msoffice" value="{{ $data->msoffice }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="antivirus" type="text"
                                                    ...
                                                    name="antivirus" value="{{ $data->antivirus }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="rujukankewpa" type="text"
                                                    ...
                                                    name="rujukankewpa" value="{{ $data->rujukankewpa }}"
