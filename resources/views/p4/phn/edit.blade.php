                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan Pusat Hidrografi Nasional</h3></div>
                                <!-- <div class="col-sm-4">
...
<!-- ---------------------------------------------END OF TEST SHOW/HIDE---------------------------------------------------- -->
                            ...
                            <div>&nbsp</div>
    <form action="/p4/phn/update/{{$data->id}}" method="POST" id="userformcreate">
        @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="pangkat" type="text"
                                            ...
                                            value="{{ $data->pangkat }}" placeholder="ALL CAPS Pangkat" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="bilcpu" type="number"
                                            ...
                                            value="{{ $data->bilcpu }}" placeholder="Bilangan Monitor" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="bilmonitor" type="number"
                                            ...
                                            value="{{ $data->bilmonitor }}" placeholder="Bilangan Monitor" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="bilmouse" type="number"
                                            ...
                                            value="{{$data->bilmouse }}" placeholder="Bilangan Mouse" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="bilkeyboard" type="number"
                                            ...
                                            value="{{ $data->bilkeyboard }}" placeholder="Bilangan Monitor" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nosirimonitor" type="text"
                                            ...
                                            value="{{ $data->nosirimonitor }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                <label for="tldmnet"
                                    class="col-md-4 col-form-label text-md-right">{{ __('TLDM NET') }}</label>

                                    <div class="col-md-6">
                                        <select class="form-control @error('tldmnet') is-invalid @enderror" name="tldmnet"
                                            value="{{ $data->tldmnet }}" >
                                            {{-- <option value="" disabled selected>Sila Pilih status</option> --}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="antivirus" type="text"
                                            ...
                                            value="{{ $data->antivirus }}" placeholder="Anti Virus" required>
                                    </div>
                                </div>
                        ...
                        <a href="/p4/phn/"><button type="button" class="btn btn-default">Back</button>
