    ...
    $(document).ready(function(){
       ...
       <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('MARKAS SELAM DAN PEPERANGAN PERIUK API') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Peralatan ICT Markas Selam dan Peperangan Periuk Api</h3></div>
                        ...
                        <a href="/si/wilayahbarat/mksppa"><button type="button" class="btn btn-default">Back</button>
