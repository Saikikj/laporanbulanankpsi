                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan Markas Selam dan Peperangan Periuk Api</h3></div>
                                <!-- <div class="col-sm-4">
                                    <button type="button" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</button>
                                </div> -->
                            </div>
                        </div>
                        <form action="/si/wilayahbarat/mksppa/update/{{$data->id}}" method="POST" id="userformcreate">
                            @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="MK SPPA">MK SPPA</option>
