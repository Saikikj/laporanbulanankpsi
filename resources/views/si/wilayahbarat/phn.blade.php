            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $data->catatan }}</td>
                                        <td>
                                            <a href="/si/wilayahbarat/phn/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                            <a href="/si/wilayahbarat/phn/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                        </td>
                                {{-- <td><a href="/si/wilayahbarat/phn/{{$data->id}}"><i class="material-icons">&#xE254;</i></a>
                                            <form method="post"
                                            action="/si/wilayahbarat/phn/{{ $data->id }}">
                                            @csrf
                                            @method('delete')
                    ...
                    <table class="table table-bordered">
                        ...
                        <a href="/si/wilayahbarat/phn/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
