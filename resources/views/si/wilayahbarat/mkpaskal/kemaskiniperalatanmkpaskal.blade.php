    ...
    // });
       ...
       <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('MARKAS PASKAL') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Peralatan ICT Markas Paskal</h3></div>
                        ...
                        <table class="table table-bordered">
                            <thead style="text-align: center" >
                                ...
                                <tr>
                                    ...
                                    <th colspan="1">KD Panglima Hitam</th>
                                    <th rowspan="1">KD Panglima Garang</th>
                        ...
                        <table class="table table-bordered">
                            <thead style="text-align: center" >
                                ...
                                <tr><th colspan="20">KOMPUTER RIBA </th></tr>
                                <tr>
                                    <th rowspan="1">Tahun</th>
                                    <th rowspan="1">Markas</th>
                                    <th colspan="1">KD Panglima Hitam</th>
                        ...
                        <table class="table table-bordered">
                            <thead style="text-align: center" >
                                <!-- Table for data update (PENCETAK) -->
                                <tr><th colspan="20">PENCETAK </th></tr>
                                <tr>
                                    <th rowspan="1">Tahun</th>
                                    <th rowspan="1">Markas</th>
                                    <th colspan="1">KD Panglima Hitam</th>
                        ...
                        <table class="table table-bordered">
                            <thead style="text-align: center" >
                                <!-- Table for data update (PENGIMBAS) -->
                                <tr><th colspan="20">PENGIMBAS </th></tr>
                                <tr>
                                    <th rowspan="1">Tahun</th>
                                    <th rowspan="1">Markas</th>
                                    <th colspan="1">KD Panglima Hitam</th>
                        ...
                        <a href="/si/wilayahbarat/mkpaskal"><button type="button" class="btn btn-default">Back</button>
