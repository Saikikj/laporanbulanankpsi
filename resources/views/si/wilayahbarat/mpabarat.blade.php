                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Peralatan ICT Markas Pemerintahan Armada Barat</h3></div>
                                <!-- <div class="col-sm-4">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach ($datas->where('jenisperalatan', 'Komputer Meja') as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->catatan }}</td>
                                        <td>
                                            <a href="/si/wilayahbarat/mpabarat/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                            <a href="/si/wilayahbarat/mpabarat/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                        </td>
                                        {{-- <td><a href="/si/wilayahbarat/mpabarat/{{$data->id}}"><i class="material-icons">&#xE254;</i></a>
                                            <form method="post"
                                            action="/si/wilayahbarat/mpabarat/{{ $data->id }}">
                                            @csrf
                                            @method('delete')
                    ...
                    <table class="table table-bordered">
                        ...
                        <a href="/si/wilayahbarat/mpabarat/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
                        </a>
                    </div>
                </div>
            </div>
