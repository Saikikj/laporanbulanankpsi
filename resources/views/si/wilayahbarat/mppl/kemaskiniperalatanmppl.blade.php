    ...
    $(document).ready(function(){
       ...
       <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('MARKAS PEMERINTAHAN PENDIDIKAN DAN LATIHAN ') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Peralatan ICT Markas Pemerintahan Pendidikan dan Latihan TLDM</h3></div>
                        ...
                        <table class="table table-bordered">
                            <thead style="text-align: center" >
                             ...
                             <!-- Table for data update (KOMPUTER MEJA)
                                <tr><th colspan="20">KOMPUTER MEJA </th></tr>
                                <tr>
                                    <th rowspan="1">Tahun</th>
                                    <th rowspan="1">Pejabat PTL</th>
                                    <th colspan="1">Pejabat TPTL</th>
                                    <th rowspan="1">Undang-Undang</th>
                                    <th rowspan="1">BSM</th>
                                    <th rowspan="1">Tadbir</th>
                                    <th rowspan="1">Protela KL</th>
                                    <th rowspan="1">KDSG</th>
                                    <th rowspan="1">RISLA</th>
                                    <th rowspan="1">BOS</th>
                                    <th rowspan="1">RMN SPC</th>
                                    <th rowspan="1">MAT</th>
                                    <th rowspan="1">JUTRA</th>
                                    <th rowspan="1">PP</th>
                                    <th rowspan="1">KPSI</th>
                                    <th rowspan="1">BIJ</th>
                        ...
                        <!-- <div class="dropdown">
                                    <button onclick="myFunction()" class="dropbtn" >UNIT</button>
                                        ...
                                        <input type="text" placeholder="Search.." id="myInput" onkeyup="filterFunction()">
                                            <a href="mktlunits/pejabatptl">Pejabat PTL</a>
                                            <a href="mktlunits/pejabattimbptl">Pejabat TPTL</a>
                                            <a href="mktlunits/undang-undang">Undang-Undang</a>
                                            <a href="mktlunits/bsm">BSM</a>
                                            <a href="mktlunits/tadbir">Tadbir</a>
                                            <a href="mktlunits/protelakl">Protela KL</a>
                                            <a href="mktlunits/kdsg">KDSG</a>
                                            <a href="mktlunits/risla">RISLA</a>
                                            <a href="mktlunits/bos">BOS</a>
                                            <a href="mktlunits/rmnspc">RMN SPC</a>
                                            <a href="mktlunits/mat">MAT</a>
                                            <a href="mktlunits/jutra">JUTRA</a>
                                            <a href="mktlunits/pp">PP</a>
                                            <a href="mktlunits/kpsi">KPSI</a>
                                            <a href="mktlunits/bij">BIJ</a>
                                        </div>
                                </div> -->
                        
                        <!-- <div class="dropdown">
                                    <button onclick="myFunction()" class="dropbtn">JENIS PERALATAN</button>
                                        <div id="myDropdown" class="dropdown-content">
                                        <input type="text" placeholder="Search.." id="myInput" onkeyup="filterFunction()">
                                            <a href="mktlperalatan/">Komputer Meja</a>
                                            <a href="mktlperalatan/">Komputer Riba</a>
                                            <a href="mktlperalatan/">Pencetak</a>
                                            <a href="mktlperalatan/">Pengimbas</a>   
                                        </div>
                                </div> -->
                        <!-- <div class="dropdown">
                                    <button onclick="myFunction()" class="dropbtn">INFO PERALATAN</button>
                                        <div id="myDropdown" class="dropdown-content">
                                        <input type="text" placeholder="Search.." id="myInput" onkeyup="filterFunction()">
                                            <a href="mktlunits/bij">Komputer Meja</a>
                                            <a href="mktlunits/bos">Komputer Riba</a>
                                            
                                        </div>
                                </div> -->
                        
                        <a href="/si/wilayahbarat/mppl"><button type="button" class="btn btn-default">Back</button>
