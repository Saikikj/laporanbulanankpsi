                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan Markas Pemerintahan Pendidikan dan Latihan TLDM</h3></div>
                                <!-- <div class="col-sm-4">
                                    <button type="button" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</button>
                                </div> -->
                            </div>
                        </div>
                        <form action="/si/wilayahbarat/mppl/update/{{$data->id}}" method="POST" id="userformcreate">
                            @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="KDSI I">KDSI I</option>
                                        <option value="KDP">KDP</option>
                                        <option value="PK TLDM">PK TLDM</option>
                                        <option value="KD SULTAN ISMAIL">KD SULTAN ISMAIL</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
