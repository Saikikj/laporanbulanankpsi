                            ...
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="dlw1">Depot Logitstik Wilayah 1</option>
                                        <option value="protelakuantan">Protela Kuantan</option>
                                        <option value="pstlkuantan">PSTL Kuantan</option>
                                        <option value="pstlsetiu">PSTL Setiu</option>
                                        <option value="kdsrikuantan">KD Sri Kuantan</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
