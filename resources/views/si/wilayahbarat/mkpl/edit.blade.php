            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/si/wilayahbarat/mkpl/update/{{$data->id}}" method="POST" id="userformcreate">
                            @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="Depot Logistik Wilayah 1">Depot Logitstik Wilayah 1</option>
                                        <option value="PROTELA Kuantan">Protela Kuantan</option>
                                        <option value="PSTL Kuantan">PSTL Kuantan</option>
                                        <option value="PSTL Setiu">PSTL Setiu</option>
                                        <option value="KD Sri Kuantan">KD Sri Kuantan</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
