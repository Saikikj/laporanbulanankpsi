            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/si/wilayahbarat/mklb/update/{{$data->id}}" method="POST" id="userformcreate">
                            @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit">
                                        ...
                                        <option value="MK LB">MK LB</option>
                                        <option value="DBAB">DBAB</option>
                                        <option value="DSAB">DSAB</option>
                                        <option value="CPKA">CPKA</option>
                                        <option value="DBB">DBB</option>
                                        <option value="Depot Peluru Barat">DEPOT PELURU BARAT</option>
                                        <option value="Depot Kenderaan TLDM">DEPOT KENDERAAN TLDM</option>
                                        <option value="Unit Pengawasan Senggaraan TLDM">UNIT PENGAWASAN SENGGARAAN TLDM</option>
                                        <option value="Pasukan Projek LCS TLDM">PASUKAN PROJEK LCS TLDM</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
