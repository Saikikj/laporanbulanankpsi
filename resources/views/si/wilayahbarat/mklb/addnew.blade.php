                            ...
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="mklb">MK LB</option>
                                        <option value="dbab">DBAB</option>
                                        <option value="dsab">DSAB</option>
                                        <option value="cpka">CPKA</option>
                                        <option value="dbb">DBB</option>
                                        <option value="depotpelurubarat">DEPOT PELURU BARAT</option>
                                        <option value="depotkenderaantldm">DEPOT KENDERAAN TLDM</option>
                                        <option value="unitpengawasansenggaraantldm">UNIT PENGAWASAN SENGGARAAN TLDM</option>
                                        <option value="pplcstldm">PASUKAN PROJEK LCS TLDM</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
