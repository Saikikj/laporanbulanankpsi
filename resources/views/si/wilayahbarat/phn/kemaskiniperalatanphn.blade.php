    ...
    $(document).ready(function(){
       ...
       <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('PUSAT HIDROGRAFI NASIONAL') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Peralatan ICT Pusat Hidrografi Nasional</h3></div>
                        ...
                        <a href="/si/wilayahbarat/phn"><button type="button" class="btn btn-default">Back</button>
