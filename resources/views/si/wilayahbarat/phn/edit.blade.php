            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/si/wilayahbarat/phn/update/{{$data->id}}" method="POST" id="userformcreate">
                            @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="KD Sri Klang">KD SRI KLANG</option>
                                        <option value="KD Sultan Azizi Shah">KD SULTAN AZIZI SHAH</option>
                                        <option value="Pusat Hidro">Pusat Hidro</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
