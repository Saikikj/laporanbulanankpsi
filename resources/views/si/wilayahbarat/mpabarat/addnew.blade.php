                            ...
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="mpabarat">MPA BARAT</option>
                                        <option value="pustakmar">PUSTAKMAR</option>
                                        <option value="ppetldm">PPE TLDM</option>
                                        <option value="sktldmlumut">SKTLDM LUMUT</option>
                                        <option value="sktldmparit">SKTLDM PARIT</option>
                                        <option value="sktldmsetiawan">SKTLDM SETIAWAN</option>
                                        <option value="kptldm">KP TLDM</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
