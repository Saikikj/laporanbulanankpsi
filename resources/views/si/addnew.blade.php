            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="kabm5">KA BM5</option>
                                        <option value="katunazizan">KA TUN AZIZAN</option>
                                        <option value="kdsrigaya">KD SRI GAYA</option>
                                        <option value="pltsr">PL TSR</option>
                                        ...
                                        <option value="kdinderasakti">KD INDERASAKTI</option>
                                        <option value="kdlaksamanatanpusmah">KD LAKSAMANA TAN PUSMAH</option>
                                        ...
                                        <option value="kdlaksamanahangnadim">KD LAKSAMANA HANG NADIM</option>
                                        <option value="kdlaksamanatunabduljamil">KD LAKSAMANA ABDUL JAMIL</option>
                                        <option value="kdlaksamanamuhamadamin">KD LAKSAMANA MUHAMAD AMIN</option>
                                        <option value="ktdpenyu">KTD PENYU</option>
                                        <option value="kldtunassamudera">KLD TUNAS SAMUDERA</option>
                                        <option value="kdperantau">KD PERANTAU</option>
                                        <option value="kdhangtuah">KD HANG TUAH</option>
                                        <option value="kdteguhsamudera">KD TEGUH SAMUDERA</option>
                                        <option value="kdgagahsamudera">KD GAGAH SAMUDERA</option>
                                        <option value="kdselangor">KD SELANGOR</option>
                                        <option value="kdperak">KD PERAK</option>
                                        <option value="kdkedah">KD KEDAH</option>
                                        <option value="kdkeris">KD KERIS</option>
                                        <option value="kdsundang">KD SUNDANG</option>
                                        <option value="kdkelantan">KD KELANTAN</option>
                                        <option value="kdserang">KD SERANG</option>
                                        <option value="kdganas">KD GANAS</option>
                                        ...
                                        <option value="kdsritiga">KD SRI TIGA</option>
                                        <option value="kdsrijohor">KD SRI JOHOR</option>
                                        <option value="kdsriperlis">KD SRI PERLIS</option>
                                        <option value="kdpari">KD PARI</option>
                                        <option value="kdjerong">KD JERONG</option>
                                        <option value="kdtodak">KD TODAK</option>
                                        <option value="kdyu">KD YU</option>
                                        <option value="kdpaus">KD PAUS</option>
                                        <option value="kdbaung">KD BAUNG</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                        ...
                        <a href="/si/armadapoh"><button type="button" class="btn btn-default">Back</button>
