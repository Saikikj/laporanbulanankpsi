                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                ...
                                <h5>ARMADA DAN PANGKALAN HADAPAN</h5>
                                <div class="col-sm-4">
                            ...
                            <tbody style="text-align: center">
                                ...
                                @foreach ($datas->where('jenis', 'Komputer Meja') as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->cadangan }}</td>
                                        <td>{{ $data->catatan }}</td>
                                        <td><a href="/si/{{$data->id}}"><i class="material-icons">&#xE254;</i></a>
                                            <form method="post"
                                            action="/si/{{ $data->id }}">
                                            @csrf
                                            @method('delete')
                        ...
                        <a href="/si/kemaskiniperalatan"><button type="button" class="btn btn-default" style="float:right;">Kemaskini Peralatan</button>
