    ...
    $(document).ready(function(){
       ...
       <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('MARKAS PEERINTAHAN KAPAL SELAM') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                            ...
                            <tbody style="text-align: center">
                                ...
                                @foreach ($datas->where('jenis', 'Komputer Meja') as $data)
                                    <tr>
                                       ...
                                       <td>{{ $data->catatan }}</td>
                                        <td>
                                            <a href="/si/wilayahtimur/mpks/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                            <a href="/si/wilayahtimur/mpks/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                        </td>
                                        {{-- <td><a href="/si/wilayahtimur/mpks/{{$data->id}}"><i class="material-icons">&#xE254;</i></a>
                                            <form method="post"
                                            action="/si/wilayahtimur/mpks/{{ $data->id }}">
                                            @csrf
                                            @method('delete')
                        ...
                        <br>
                        <a href="/si/wilayahtimur"><button type="button" class="btn btn-default">Back</button>
                        <a href="/si/index"><button type="button" class="btn btn-default">Home</button>
                        <a href="/si/wilayahtimur/mpks/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
