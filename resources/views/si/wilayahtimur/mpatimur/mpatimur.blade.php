                                ...
                                <div class="dropdown">
                                    <button onclick="myFunction()" class="dropbtn">UNIT</button>
                                        ...
                                        <input type="text" placeholder="Search.." id="myInput" onkeyup="filterFunction()">
                                            <a href="mpatimur">MPA Timur</a>
                                            <a href="skn601">SKN 601</a>
                                            <a href="stnlima">STN LIMA</a>
                                            <a href="stnuniform">STN UNIFORM</a>
                                            <a href="stnmike">STN MIKE</a>
                                            <a href="stnsierra">STN SIERRA</a>
                                            <a href="stnpapa">STN PAPA</a>
                                            <a href="pwtlkuching2">PWTL KUCHING</a>
