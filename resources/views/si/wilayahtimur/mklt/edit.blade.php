                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan Markas Logistik Timur</h3></div>
                                <!-- <div class="col-sm-4">
                            ...
                            <!-- INPUT -->
                            <form action="/si/wilayahtimur/mklt/update/{{$data->id}}" method="POST" id="userformcreate">
                                @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                     ...
                                     <option value="{{ $data->unit }}" selected hidden>{{ $data->unit }}</option>
                                        ...
                                        <option value="upstimur">UPS TIMUR</option>
                                        <option value="dbat">DBAT</option>
                                        <option value="dsat">DSAT</option>
                                        <option value="dpbltimur">DPBL TIMUR</option>
                                        <option value="depotbantuantimur">DEPOT BANTUAN TIMUR</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
