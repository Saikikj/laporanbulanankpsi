    ...
    $(document).ready(function(){
       ...
       <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('MARKAS LOGISTIK TIMUR') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Peralatan ICT Markas Logistik Timur</h3></div>
                        ...
                        <a href="/si/wilayahtimur/mklt"><button type="button" class="btn btn-default">Back</button>
