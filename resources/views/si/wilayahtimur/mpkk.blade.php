            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <tbody style="text-align: center">
                                ...
                                @foreach ($datas->where('jenis', 'Komputer Meja') as $data)
                                    <tr>
                                       ...
                                       <td>{{ $data->catatan }}</td>
                                        <td>
                                            <a href="/si/wilayahtimur/mpkk/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                            <a href="/si/wilayahtimur/mpkk/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                        </td>
                                        {{-- <td><a href="/si/wilayahtimur/mpkk/{{$data->id}}"><i class="material-icons">&#xE254;</i></a>
                                            <form method="post"
                                            action="/si/wilayahtimur/mpkk/{{ $data->id }}">
                                            @csrf
                                            @method('delete')
                        ...
                        <a href="/si/wilayahtimur/mpkk/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
