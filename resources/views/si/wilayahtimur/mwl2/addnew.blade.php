                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            ...
                            <form action="/si/wilayahtimur/mwl2" method="POST" id="userformcreate">
                                @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="Markas Wilayah Laut 2">Markas Wilayah Laut 2</option>
                                        <option value="Depot Logistik Wilayah 2">Depot Logistik Wilayah 2</option>
                                        <option value="KD SRI SANDAKAN">KD SRI SANDAKAN</option>
                                        <option value="PROTELA Sandakan">PROTELA Sandakan</option>
                                        <option value="PSTL Sandakan">PSTL Sandakan</option>
                                        <option value="KD SRI SEMPORNA">KD SRI SEMPORNA</option>
                                        <option value="KD SRI TAWAU">KD SRI TAWAU</option>
                                        <option value="PSTL Tawau">PSTL Tawau</option>
                                        <option value="PSTL Labuan">PSTL Labuan</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
