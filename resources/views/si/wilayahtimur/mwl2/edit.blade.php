                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            ...
                            <!-- INPUT -->
                            <form action="/si/wilayahtimur/mwl2/update/{{$data->id}}" method="POST" id="userformcreate">
                                @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="markaswilayahlaut2">Markas Wilayah Laut 2</option>
                                        <option value="depotlogistikwilayah2">Depot Logistik Wilayah 2</option>
                                        <option value="kdsrisandakan">KD SRI SANDAKAN</option>
                                        <option value="protelasandakan">PROTELA Sandakan</option>
                                        <option value="pstlsandakan">PSTL Sandakan</option>
                                        <option value="kdsrisemporna">KD SRI SEMPORNA</option>
                                        <option value="kdsritawau">KD SRI TAWAU</option>
                                        <option value="pstltawau">PSTL Tawau</option>
                                        <option value="pstllabuan">PSTL Labuan</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
