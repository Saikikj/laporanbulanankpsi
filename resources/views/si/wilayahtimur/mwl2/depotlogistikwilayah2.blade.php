                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                ...
                                <h5>DEPOT LOGISTIK WILAYAH 2</h5>
                                <div class="col-sm-4">
                                ...
                                <div class="dropdown">
                                    <button onclick="myFunction()" class="dropbtn">UNIT</button>
                                        ...
                                        <input type="text" placeholder="Search.." id="myInput" onkeyup="filterFunction()">
                                            <a href="mwl2">Markas Wilayah Laut 2</a>
                                            <a href="depotlogistikwilayah2">Depot Logistik Wilayah 2</a>
                                            <a href="kdsrisandakan">KD SRI SANDAKAN</a>
                                            <a href="protelasandakan">PROTELA Sandakan</a>
                                            <a href="pstlsandakan">PSTL Sandakan</a>
                                            <a href="kdsrisemporna">KD SRI SEMPORNA</a>
                                            <a href="kdsritawau">KD SRI TAWAU</a>
                                            <a href="pstltawau">PSTL Tawau</a>
                                            <a href="pstllabuan">PSTL Labuan</a>
