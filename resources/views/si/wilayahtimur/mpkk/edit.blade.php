                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h3>Kemaskini Peralatan Markas Pangkalan Kota Kinabalu</h3></div>
                                <!-- <div class="col-sm-4">
                            ...
                            <!-- INPUT -->
                            <form action="/si/wilayahtimur/mpkk/update/{{$data->id}}" method="POST" id="userformcreate">
                                @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit">
                                        ...
                                        <option value="upstldmtimur">UPS TLDM TIMUR</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
                        ...
                        <a href="/si/wilayahtimur/mpkk/addnew"><button type="button" class="btn btn-default">Back</button>
