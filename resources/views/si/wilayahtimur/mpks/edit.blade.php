                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            ...
                            <!-- INPUT -->
                            <form action="/si/wilayahtimur/mpks/update/{{$data->id}}" method="POST" id="userformcreate">
                                @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="mpks">MPKS</option>
                                        <option value="plks">PLKS</option>
                                        <option value="kdtar">KD TAR</option>
                                        <option value="kdtunabdulrazak">KD TUN ABDUL RAZAK</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
