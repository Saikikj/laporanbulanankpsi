                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            ...
                            <form action="/si/wilayahtimur/mpks" method="POST" id="userformcreate">
                                @csrf
                        <div class="container-fluid">
                            <div class="row justify-content-center">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control @error('unit') is-invalid @enderror" name="unit"
                                        ...
                                        <option value="KD TAR">KD TAR</option>
                                        <option value="KD TUN ABDUL RAZAK">KD TUN ABDUL RAZAK</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="row justify-content-center">
