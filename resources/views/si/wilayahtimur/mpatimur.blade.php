            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <tbody style="text-align: center">
                                ...
                                @foreach ($datas->where('jenisperalatan', 'Komputer Meja') as $data)
                                    <tr>
                                       ...
                                       <td>{{ $data->catatan }}</td>
                                        <td>
                                            <a href="/si/wilayahtimur/mpatimur/delete/{{ $data->id }}" class="btn btn-danger">Delete</a>
                                            <a href="/si/wilayahtimur/mpatimur/{{ $data->id }}" class="btn btn-danger">Edit</a>
                                        </td>
                                        {{-- <td><a href="/si/wilayahtimur/mpatimur/{{$data->id}}"><i class="material-icons">&#xE254;</i></a>
                                            <form method="post"
                                            action="/si/wilayahtimur/mpatimur/{{ $data->id }}">
                                            @csrf
                                            @method('delete')
                        ...
                        <a href="/si/wilayahtimur/mpatimur/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>
