                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>Penggunaan <b>FBB</b></h2></div>
                                <div class="col-sm-4">
                        ...
                        <table class="table table-bordered">
                            <thead style="text-align: center" >
                                <tr>
                                    <th>Bil</th>
                                    <th>ID Rujukan Kad Sim
                                    <th>No Kad Sim</th>
                                    <th>Pakej</th>
                                    <th>Tarikh Tamat Langganan</th>
                                    <th>Jumlah Penggunaan Data Bulanan</th>
                                    <th>Baki Data Tahunan</th>
                                    <th>Catatan</th>
                                    <th>Tindakan</th>
                                </tr>   
                            </thead>                               
                            <tbody style="text-align: center">
                                <tr>
                                    <td>1.</td>
                                    <td>KK 3</td>
                                    <td style="text-align: left">898709908414113605</td>
                                    <td>3gb</td>
                                    <td>28-Jan-22</td>
                                    <td>250mb</td>
                                    <td>373mb</td>
                                    <td>PINJAMAN MAWILLA 1</td>
                                    <td>
