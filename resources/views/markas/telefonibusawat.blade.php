    ...
    $(document).ready(function(){
       ...
       <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    <div class="card-header text-center">{{ __('IBU SAWAT TELEFON') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>IBU SAWAT <b>TELEFON</b></h2></div>
                                <div class="col-sm-4">
            ...
            <a href="/kom/telefon"><button type="button" class="btn btn-default" style="float:right;">PENGOPERASIAN</button> 
