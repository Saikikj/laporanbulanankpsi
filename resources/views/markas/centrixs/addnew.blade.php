                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>Status Peralatan <b>Centrixs</b></h2></div>
                                <div class="col-sm-4">
                        ...
                        <!-- <a href="centrixs/addnew"><button type="button" class="btn btn-default" style="float:right;">Tambah Peralatan</button>  -->
