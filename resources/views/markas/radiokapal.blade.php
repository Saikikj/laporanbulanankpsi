...
<div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col">
                <div class="card">
                    {{-- <div class="card-header text-center">{{ __('PERALATAN RADIO PANGKALAN') }}</div> --}}
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>RADIO <b>KAPAL</b></h2></div>
                                <div class="col-sm-4">
            ...
            <a href="/kom/radio"><button type="button" class="btn btn-default" style="float:right;">PANGKALAN</button> 
            <a href="/kom/radio"><button type="button" class="btn btn-default">back</button>
